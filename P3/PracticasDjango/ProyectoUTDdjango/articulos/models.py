...
class Category(models.Model):
    ...
    description = models.CharField(max_length=255, verbose_name='Descripcion', default="No description available")
...
class Article(models.Model):
    ...
    image = models.ImageField(null=True, blank=True, verbose_name='Imagen', upload_to="articles")
